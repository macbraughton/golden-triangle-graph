...
export const B = (h: number, x = 0, y = 0): number[] => [x + c(h) / 2, y + h / 2];
export const C = (h: number, x = 0, y = 0): number[] => [x - c(h) / 2, y + h / 2];
export const D = (h: number, x = 0, y = 0): number[] => [x + c(h / 2) / 2, y - h / 2];
export const E = (h: number, x = 0, y = 0): number[] => [x + c(h / 2), y];
export const F = (h: number, x = 0, y = 0): number[] => [x + c(h / 2) / 2, y + h / 2];
export const G = (h: number, x = 0, y = 0): number[] => [x - c(h / 2) / 2, y + h / 2];
export const H = (h: number, x = 0, y = 0): number[] => [x - c(h / 2), y];
export const I = (h: number, x = 0, y = 0): number[] => [x - c(h / 2) / 2, y - h / 2];